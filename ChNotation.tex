...
\paragraph*{kurtosis} \index{kurtosis}\index{excess kurtosis} Kurtosis measures the peakedness of a distribution. The normal distribution has zero excess kurtosis. A positive kurtosis distribution longer tails, while a negative kurtosis distribution has shorter tails.
