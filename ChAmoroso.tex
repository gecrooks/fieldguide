...
\dist{Inverse Maxwell} distribution~\cite{Shakil2010}:
%
\begin{align}
\label{InvMaxwell}
...
\dist{Inverse half normal} distribution~\cite{Shakil2010}:
%
\begin{align}
\label{InvHalfNormal}
...
\dist{Inverse Nakagami} distribution~\cite{Louzada2018}:
\begin{align}
\label{InvNakagami}
