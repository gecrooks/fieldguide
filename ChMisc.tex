...
\[
\opr{Meridian}(x\given 0,\tfrac{s_1}{s_2}) \sim \frac{\opr{Laplace}_1(0,s_1)} {\opr{Laplace}_2(0,s_2)} \checked
\]
...
\dist{Stable} (L\'evy skew alpha-stable, L\'{e}vy stable) distribution~\cite{Nolan2015}:
...
\end{align*}
for real  constants $a_1,a_2,a_3,b$. 
