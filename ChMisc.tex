...
\secbreak
\dist{Johnson SU} distributions~\cite{Johnson1949a,Johnson1994}:
\[
\label{JohnsonSU}
...
\secbreak
%===========================================================================
\dist{Skew-t} (beta-t) distribution~\cite{Jones2004}:
\begin{align}
\label{SkewT}
...
\end{align}
The order statistics \secref{OrderStatistic} of Student's $t_2$ distribution~\eqref{StudentsT2}.
\[
