...
1.0 (2019-04-01)
First print edition. 
Over 170 named univariate continuous probability distributions, and at least as many synonyms.
Added
inverse Maxwell \eqref{InvMaxwell},
inverse half-normal \eqref{InvHalfNormal},
inverse Nakagami \eqref{InvNakagami},
reciprocal inverse Gaussian \eqref{RecInvGaussian},
generalized Sichel \eqref{GenSichel},
Pearson exponential \eqref{PearsonExp},
Perks \eqref{Perks},
and
noncentral chi \eqref{NoncentralChi}.
distributions.
Added diagram of the Pearson-exponential hierarchy (Fig.~\ref{PearsonExpHierarchy}).
Renamed the Pearson II distribution to central-beta, and the symmetric beta-logistic distribution to central-logistic.
% Fixed  typos
}
...
\noindent
``\emph{Ridiculously useful!}'' -- Mara Averick\footnote{twitter}%\footnote{\url{https://twitter.com/dataandme/status/770732084872810496}}
\\

%\noindent
%``\emph{I can't stress how useful I've found this. I wish I'd had a printout of it by my desk every day for the last 6 years}''-- Guillermo Roditi Dominguez 
% \footnote{\url{https://twitter.com/groditi/status/772266190190194688}}
% \\
