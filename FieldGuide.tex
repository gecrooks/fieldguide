...
\documentclass[mediaeval, pagebackref, book]{gecstyle}
...
\hidenotes		% Comment this line to hide notes and checkmarks
%\overfullrule=1mm
...
\newcommand{\version}{v~0.12~{\sc{beta}}}
...
\title{\vspace{3em}\scshape{Field Guide  \\ to  \\ Continuous \\ Probability  Distributions} \vspace{1em} }
