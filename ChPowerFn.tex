...
\begin{align}
\label{Pareto}
\opr{Pareto}(x\given a,s,\gamma) &= \Left| \frac{\gamma}{s}\Right| \Left(\frac{x-a}{s}\Right)^{\gamma-1}   \qquad \gamma>0
\checked
...
\eqref{UniPrime} & uniform prime & .& . & -1 & \\
...
\input{PropertiesTablePowerFunc}
