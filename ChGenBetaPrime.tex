...
\input{PropertiesTableGenBetaPrime}
...
\dist{Log-logistic} (Fisk, Weibull-exponential, Pareto type III, power prime) distribution~\cite{Shah1963, Johnson1995, McDonald1995}:
\begin{align}
\label{LogLogistic}
