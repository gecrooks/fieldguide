...
%\\
%\lim_{a\rightarrow\infty} Q(a;z) &= \tfrac{1}{2} \op{erfc} \left(\frac{z-a}{\sqrt{2a} }\right) 
%+ O\left( \frac{1}{\sqrt{a}} \right) 
%&\text{\cite{Tricomi1950}}
%%{Check. Do we still care? \\}
\end{align*}
%The derivative is $\tfrac{d}{dz} Q(a;z) = -\tfrac{1}{\Gamma(a)} z^{a-1} e^{-z}$. 
...
\paragraph*{Regularized beta function}\hspace{-0.8em}:
...
% tan and sin? or too standard to bother including?
